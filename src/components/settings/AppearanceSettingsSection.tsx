...
import { ChevronRightIcon, EyeIcon, MinusIcon, PlusIcon } from "../icons/velocity";
...
const fontFamilyOptions: { value: FontFamily; label: string }[] = [
  { value: "system-sans", label: "SN Pro" },
        ...
        <div className="rounded-[10px] border border-border pl-4 py-3 pr-3 space-y-2">
          ...
          <div className="flex items-center justify-between">
            ...
            <Select
              ...
              onValueChange={(value) =>
                setEditorFontSetting("boldWeight", Number(value))
              }
              className="w-40"
            >
          ...
          <div className="flex items-center justify-between">
            ...
            <Select
              value={editorWidth}
              onValueChange={(value) => setEditorWidth(value as EditorWidth)}
              className="w-40"
            >
